...
- 🔭 Working on AI + Angular integrations
- 🤖 Learning Agentic AI, LangChain, MCP, and LLM Evaluation
- 💻 Passionate about Angular Frontend architecture
- 🔐 Experienced in Angular | MicroFrontEnd | Nx Monorepo | NGRX | RXJS | GraphQL | TypeScript | JavaScript
- ☁️ Exploring Azure AI Foundry and cloud-native AI apps
